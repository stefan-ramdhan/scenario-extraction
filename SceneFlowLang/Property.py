...
predicate_type = List[Tuple[str, Union[partial, Any]]]
predicate_type_dict = Dict[str, Union[partial, Any]]
...
class Property:
    ...
    def __evaluate_predicate(self, predicate, sg, func_chain=None):
        ...
        if predicate.func.__name__ in ['filterByAttr', 'relSet']:
            return predicate.func(*param_list, sg, None, **predicate.keywords)
        else:
